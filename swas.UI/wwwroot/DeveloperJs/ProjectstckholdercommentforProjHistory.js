...
//    debugger;
//    var Isprocess = $("#IsProcess").html().toLowerCase();
    
//    $('.FwdDropdown').addClass('col-md-3');
//    $('.FwdDropdown').addClass('col-md-6');
//    $('.ProjectsFwdUnit').addClass('d-none');
    
//    let date_type_raw = $('#spnLatestActiontype').html()
//    let date_type = (String(date_type_raw).toLowerCase() === "approved");
//    fetchServerDate().then(function (S) {
...
//        mMsaterfwdStage($("#SpnStagesid").html(), "ddlfwdStage", 5, 0, 1, 1)
//    }
//    else if (words.includes("Re-Vetted")) {

//        mMsaterfwdStage($("#SpnStagesid").html(), "ddlfwdStage", 5, 0, 1, "Re-Vetted")
//    }
//    else {
//        mMsaterfwdStage($("#SpnStagesid").html(), "ddlfwdStage", 5, 0, 1)
//    }


//    mMsaterStage($("#SpnStatusid").html(), "ddlfwdSubStage", 6, $("#SpnStagesid").html(), $('#spnStakeholderid').html())
//    mMsaterFwdTo($("#SpnFromUnitid").html(), "ddlfwdFwdTo", 8, 0, $('#spnStakeholderid').html(), 0, "");

//    mMsater($("#SpnActionsid").html(), "ddlfwdAction", 7, $("#SpnStatusid").html())

//    // mMsaterFwdTo($(this).closest("tr").find("#SpnTimeFromUnitId").html(), "ddlfwdFwdTo", 8, 0, 1, 0, "");

//    mMsaterFwdTo(0, "ddlfwdCCTo", 8, 0, $('#spnStakeholderid').html(), 0, "");
//    $("#searchBox").val('');
//    $("#searchBox").hide();
